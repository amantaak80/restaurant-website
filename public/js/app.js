...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', pizza).then(function (res) {
    ...
    new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
      //this will give a pop of item added into cart
      type: 'success',
      timeout: 300,
      text: "Item added to cart",
      progressBar: true // layout: 'topLeft'
...
var alertMsg = document.querySelector('#success-alert'); //in all orders we want to hide success msg after 1 sec
